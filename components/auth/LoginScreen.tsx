...
const OPERATOR_CLASS =
  "flex h-14 items-center justify-center rounded-2xl border border-ocean-300/20 bg-ocean-300/10 text-xl font-semibold text-ocean-300 transition hover:bg-ocean-300/20 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40";
type Operator = "+" | "−" | "×" | "÷";
        ...
        <form onSubmit={handleSubmit}>
          <div className="premium-glass rounded-[2rem] p-3 shadow-premium">
            <div
              ...
              className="flex min-h-[5.5rem] items-end justify-center rounded-[1.35rem] bg-ocean-50 px-5 py-3 text-right shadow-inner"
            >
              <span
                aria-live="polite"
                className="min-h-8 w-full truncate font-mono text-3xl tracking-[0.14em] text-ocean-950"
              >
                {error ? "Error" : code || "0"}
              </span>
            </div>
